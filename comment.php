<html>
    <head>
        ...
        font-family:Noto Sans HK;">
          ...
          <a style="background-color:rgb(37, 29, 18);border-radius:10px;padding:7px;"href="comment.php">Comments</a>
          <a style="  text-decoration:none;
          color:white;
      ...
      background-color: rgb(44, 43, 43);">
        <h1 style="font-size:45px;font-family:Noto Sans HK;font-weight: 500;color:rgb(194, 129, 105)"> Javascript Comments </h1><br><br><br>
        ...
        height:2px;
        width:800px;"></div><br><br>
        <h4 style="font-size:17px;font-family:Noto Sans HK;font-weight:300;" >Single Line Comments<br>
...
This example uses a single-line comment before each code line:</h4><br><br>
            <div style=" background-color: rgb(24, 23, 23);
        height:2px;
        width:800px;"></div><br><br>
      ...
      background-color: rgb(32, 31, 31);">
            ...
            <form action="code3.php">
             ...
             <h3 style="font-size:23px;font-family:Noto Sans HK;font-weight:500;color:rgb(194, 129, 105)">Multi-line Comments</h3><br><br>
               <div style="font-size:17px;font-family:Noto Sans HK;font-weight:300;">
               Multi-line comments start with /* and end with */.<br>

Any text between /* and */ will be ignored by JavaScript.<br>

This example uses a multi-line comment (a comment block) to explain the code:<br><br>
         </div><br><br><br>
