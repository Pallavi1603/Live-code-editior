<html>
    <head>
        ...
        font-family:Noto Sans HK;">
          ...
          <a style="background-color:rgb(37, 29, 18);border-radius:10px;padding:7px;" href="assignment.php">Assignment</a>   
          <a style="  text-decoration:none;
          color:white;
      ...
      background-color: rgb(44, 43, 43);">
        <h1 style="font-size:45px;font-family:Noto Sans HK;font-weight: 500;color:rgb(194, 129, 105)"> JavaScript Assignment </h1><br><br><br>
        ...
        height:2px;
        width:800px;"></div><br><br>
        <h4 style="font-size:17px;font-family:Noto Sans HK;font-weight:300;" >JavaScript Assignment Operators<br>
        Assignment operators assign values to JavaScript variables.<br>
      

The **= operator is a part of ECMAScript 2016.<br>
...
The = assignment operator assigns a value to a variable.
      ...
      background-color: rgb(32, 31, 31);">
            ...
            <form action="code3.php">
             ...
             <h3 style="font-size:23px;font-family:Noto Sans HK;font-weight:500;color:rgb(194, 129, 105)">Assignment Operators</h3><br><br>
               <div style="font-size:17px;font-family:Noto Sans HK;font-weight:300;">
               The += assignment operator adds a value to a variable.
               <br>The -= assignment operator subtracts a value from a variable.<br>
               The *= assignment operator multiplies a variable.<br>
               The /= assignment divides a variable.<br>
               The %= assignment operator assigns a remainder to a variable.<br><br>
         </div><br><br><br>
