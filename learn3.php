<html>
    <head>
        ...
        margin-left:12px;"
          ...
          <a style="  text-decoration:none;
          color:white;
          margin-left:12px;" href="datatype.php">Data types</a> 
          <a style="  text-decoration:none;
          color:white;
      ...
      background-color: rgb(44, 43, 43);">
        <h1 style="font-size:45px;font-family:Noto Sans HK;font-weight: 500;color:rgb(194, 129, 105)"> Javascript Tutorial </h1><br><br><br>
        <div style=" background-color: rgb(24, 23, 23);
        height:2px;
        width:800px;"></div><br><br>
        <h4 style="font-size:17px;font-family:Noto Sans HK;font-weight:500;">JavaScript is the world's most popular programming language and it 
        is the programming language of the Web.</h4><br><br>
        <div style=" background-color: rgb(24, 23, 23);
        height:2px;
        width:800px;"></div><br><br>
        <h4 style="font-size:17px;font-family:Noto Sans HK;font-weight:300;" >JavaScript is a lightweight, interpreted programming language. It is designed for creating network-centric
         applications. It is complimentary to and integrated with Java. JavaScript is very easy to implement because it is integrated with HTML. 
         It is open and cross-platform.Javascript is a MUST for students and working professionals to become a great Software Engineer specially
          when they are working in Web Development Domain. I will list down some of the key advantages of learning Javascript.</h4><br><br>
            <div style=" background-color: rgb(24, 23, 23);
        height:2px;
        width:800px;"></div><br><br>
      ...
      background-color: rgb(32, 31, 31);">
            ...
            <form action="code3.php">
             ...
             <h1 style="font-size:30px;text-align:center;font-family:Noto Sans HK;font-weight: 500;color:rgb(194, 129, 105)">Javascript Tutorial</h1>
             <video style="margin-left:5px" width="420" height="300" controls>
              <source src="javascript course.mp4" type="video/mp4">
            </video>
