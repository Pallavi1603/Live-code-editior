...
<html lang=en>
    ...
    <body>
        <div class="editior-menu">
            <a style="font-size:35px;text-decoration:none;background-color: black;border-radius:5px;color:white;padding-left:10px;padding-right:10px;padding-top:3px;padding-bottom:0px;margin-right:10px" href="Home.php" class="topnav-icons fa fa-home w3-left w3-bar-item w3-button"   title="Home"></a>            
