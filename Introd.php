<html>
    <head>
      ...
      background-color: rgb(44, 43, 43);">
        <h1 style="font-size:45px;font-family:Noto Sans HK;font-weight: 500;color:rgb(194, 129, 105)"> Javascript Introduction </h1><br><br><br>
...
This page contains some examples of what JavaScript can do.
        ...
        height:2px;
        width:800px;"></div><br><br>
        <h4 style="font-size:17px;font-family:Noto Sans HK;font-weight:300;" >JavaScript Can Change HTML Content<br>
        One of many JavaScript HTML methods is getElementById().<br>
        The example below "finds" an HTML element (with id="demo"), and changes the element content (innerHTML) to 150:</h4><br><br>
            <div style=" background-color: rgb(24, 23, 23);
        height:2px;
        width:800px;"></div><br><br>
      ...
      background-color: rgb(32, 31, 31);">
            ...
            <form action="code3.php">
             ...
             <h3 style="font-size:23px;font-family:Noto Sans HK;font-weight:500;color:rgb(194, 129, 105)">JavaScript Can Change HTML Attribute Values</h3><br><br>
               <div style="font-size:17px;font-family:Noto Sans HK;font-weight:300;">
               JavaScript Can Change HTML Styles (CSS).<br>
               Changing the style of an HTML element, is a variant of changing an HTML attribute.<br>
               JavaScript Can Hide HTML Elements<br>

Hiding HTML elements can be done by changing the display.<br>
JavaScript Can Show HTML Elements<br>

Showing hidden HTML elements can also be done by changing the display style.<br><br>
         </div><br><br><br>
