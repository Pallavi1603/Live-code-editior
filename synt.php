<html>
    <head>
        ...
        font-family:Noto Sans HK;">
          ...
          <a style="background-color:rgb(37, 29, 18);border-radius:10px;padding:7px;" href="synt.php">Syntax</a>
          <a style="  text-decoration:none;
          color:white;
      ...
      background-color: rgb(44, 43, 43);">
        <h1 style="font-size:45px;font-family:Noto Sans HK;font-weight: 500;color:rgb(194, 129, 105)">JavaScript Syntax </h1><br><br><br>
        ...
        height:2px;
        width:800px;"></div><br><br>
        <h4 style="font-size:17px;font-family:Noto Sans HK;font-weight:300;" >JavaScript Values<br>
...
<br>
      ...
      background-color: rgb(32, 31, 31);">
            ...
            <form action="code3.php">
             ...
             <h3 style="font-size:23px;font-family:Noto Sans HK;font-weight:500;color:rgb(194, 129, 105)">JavaScript Literals</h3><br><br>
               <div style="font-size:17px;font-family:Noto Sans HK;font-weight:300;">
               The two most important syntax rules for fixed values are:<br>
               1. Numbers are written with or without decimals:<br>
