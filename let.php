<html>
    <head>
        ...
        font-family:Noto Sans HK;">
          ...
          <a style="background-color:rgb(37, 29, 18);border-radius:10px;padding:7px;" href="let.php">Let</a>
          <a style="  text-decoration:none;
          color:white;
          ...
          <a  href="datatype.php">Data types</a> 
          <a style="  text-decoration:none;
          color:white;
      ...
      background-color: rgb(44, 43, 43);">
        <h1 style="font-size:45px;font-family:Noto Sans HK;font-weight: 500;color:rgb(194, 129, 105)"> JavaScript Let </h1><br><br><br>
        ...
        height:2px;
        width:800px;"></div><br><br>
        <h4 style="font-size:17px;font-family:Noto Sans HK;font-weight:300;" >Let<br>
        Variables defined with let cannot be Redeclared.<br>

Variables defined with let must be Declared before use.<br>

Variables defined with let have Block Scope.</h4><br><br>
            <div style=" background-color: rgb(24, 23, 23);
        height:2px;
        width:800px;"></div><br><br>
      ...
      background-color: rgb(32, 31, 31);">
            ...
            <form action="code3.php">
             ...
             <h3 style="font-size:23px;font-family:Noto Sans HK;font-weight:500;color:rgb(194, 129, 105)">Cannot be Redeclared</h3><br><br>
               <div style="font-size:17px;font-family:Noto Sans HK;font-weight:300;">
               Variables defined with let cannot be redeclared.<br>

You cannot accidentally redeclare a variable.<br>

With let you can not do this.
Before ES6 (2015), JavaScript had only Global Scope and Function Scope.<br>

ES6 introduced two important new JavaScript keywords: let and const.<br><br>
         </div><br><br><br>
