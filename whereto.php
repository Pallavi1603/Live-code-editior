<html>
    <head>
        ...
        font-family:Noto Sans HK;">
          ...
          <a style="background-color:rgb(37, 29, 18);border-radius:10px;padding:7px;" href="whereto.php"> Where to</a>
      ...
      background-color: rgb(44, 43, 43);">
        <h1 style="font-size:45px;font-family:Noto Sans HK;font-weight: 500;color:rgb(194, 129, 105)"> Javascript Where to </h1><br><br><br>
        ...
        height:2px;
        width:800px;"></div><br><br>
        <h4 style="font-size:17px;font-family:Noto Sans HK;font-weight:300;" >JavaScript Functions and Events<br>
        A JavaScript function is a block of JavaScript code, that can be executed when "called" for.<br>
        Old JavaScript examples may use a type attribute: script type="text/javascript".<br>
The type attribute is not required. JavaScript is the default scripting language in HTML.</h4><br><br>
            <div style=" background-color: rgb(24, 23, 23);
        height:2px;
        width:800px;"></div><br><br>
      ...
      background-color: rgb(32, 31, 31);">
            ...
            <form action="code3.php">
             ...
             <h3 style="font-size:23px;font-family:Noto Sans HK;font-weight:500;color:rgb(194, 129, 105)">JavaScript Functions and Events</h3><br><br>
               <div style="font-size:17px;font-family:Noto Sans HK;font-weight:300;">
               A JavaScript function is a block of JavaScript code, that can be executed when "called" for.<br>
               JavaScript in head or body<br>
               You can place any number of scripts in an HTML document.<br>
               Scripts can be placed in the body, or in the head section of an HTML page, or in both.<br><br>
         </div><br><br><br>
