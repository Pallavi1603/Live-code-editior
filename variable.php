<html>
    <head>
        ...
        font-family:Noto Sans HK;">
          ...
          <a style="background-color:rgb(37, 29, 18);border-radius:10px;padding:7px;" href="variable.php">Variables</a>
          <a style="  text-decoration:none;
          color:white;
      ...
      background-color: rgb(44, 43, 43);">
        <h1 style="font-size:45px;font-family:Noto Sans HK;font-weight: 500;color:rgb(194, 129, 105)"> JavaScript Variables </h1><br><br><br>
        ...
        height:2px;
        width:800px;"></div><br><br>
        <h4 style="font-size:17px;font-family:Noto Sans HK;font-weight:300;" >Variables<br>
        There are 3 ways to declare a JavaScript variable:<br>

        Using var
    Using let
    Using const.<br>
    This chapter uses var.<br>

The let and const keywords are explained in the next chapters.<br>
</h4><br><br>
            <div style=" background-color: rgb(24, 23, 23);
        height:2px;
        width:800px;"></div><br><br>
      ...
      background-color: rgb(32, 31, 31);">
            ...
            <form action="code3.php">
             ...
             <h3 style="font-size:23px;font-family:Noto Sans HK;font-weight:500;color:rgb(194, 129, 105)">Variables</h3><br><br>
